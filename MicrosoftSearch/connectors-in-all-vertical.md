...
Inline merging allows users to find relevant content in the search results page from all relevant sources. Microsoft 365 Copilot connectors' results are seamlessly integrated into the search page and are ranked by their relevance to the search query. See the table below for a comparison of Microsoft 365 Copilot connectors in Result cluster versus Inline mode. 
...
* All vertical sorting by date doesn't apply to connector results. Sorting by date instead of relevance will exclude connector results.
