...
2. Navigate to the user profile setting page with the administrator account in the Freshservice application. Find the API key and copy it. Refer to [Where do I find my API key?](https://support.freshservice.com/support/solutions/folders/50000000029) for details.
